...
<script type="text/javascript">
	...
	var loginFlag='<s:property value="loginFlag" escape="false"/>';
	var loginTime='<s:property value="loginTime" escape="false"/>';
...
<!-- 获取语言 -->
<script type="text/javascript" src="userlogin/js/getLanguage.js"></script>
	        ...
	        <div id="J_LoginBox" class="login-box   no-longlogin module-static">
	            <div class="bd">
	                   ...
	                   <div id="J_Static" class="static">
	                     <form action="client/userLogin.action">
	                     <input type="text" name="type" id="type"  value="0" readonly="readonly" style="display: none">
	                        	<div>
		                        	<ul class="quick-menu">
	                        	...
	                        	<div class="field ph-hide username-field">
		                            ...
		                            <input type="text" name="username" id="TPL_username_1" class="login-text J_UserName" value="" maxlength="32" tabindex="1" placeholder='<s:text name="www.login.accountTips"></s:text>' >              
		                        	<span id="J_NickX1420787893107" class="nickx" href="javascript:void(0)" style="display: block;"></span>
	                        	</div>
	                            <div class="field pwd-field">
	                                ...
	                                <span id="J_StandardPwd">
	                                    <input type="password" aria-labelledby="password-label" name="password" id="TPL_password_1" class="login-text" maxlength="20" tabindex="2" placeholder='<s:text name="www.login.passwordTips"></s:text>'>
	                                </span>
	                                <span id="J_PasswordEdit" class="password-edit" style="display:none;">
	                                </span>      
	                                
	                                <strong id="J_CapsLockTip" class="warning-tip" style="display:none;">
	                                	Caps Lock键正处于启用状态，<br>启用它可能导致密码输入错误。
	                                </strong>
	                            </div>
	                            <div class="field field-checkcode hidden" id="l_f_code" style="display:none;">
	                                  ...
	                                  <input  id="J_CodeInput_i" type="text" name="checkcode" class="login-text checkcode J_CheckCode" maxlength="4"  tabindex="3">
	                                  
	                                  <img style="padding: 1px 0px;margin: -9px 0px;" title="点击更换" onclick="javascript:refresh(this);" src="Security/SecurityCodeImageAction">
